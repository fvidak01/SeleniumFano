...
// Starting URL
const rootURL:string = process.env.SUB_PLANS_SENIOR || "https://finansavisen.no/abonnement/senior";
// in ms
...
// 
// Testing if 'Senior' offer loads correct forms
// 
